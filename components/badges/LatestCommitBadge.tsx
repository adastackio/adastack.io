...
const LatestCommitBadge = ({ repoURL }) => {
  ...
  return (
    <a href={repoURL} target="_blank" rel="noopener noreferrer">
      <span
        className="last-commit-badge-content inline-flex items-center rounded-md bg-blue-50 px-2 py-1 text-sm text-blue-700 ring-1 ring-inset dark:ring-0 ring-blue-700/10 nx-whitespace-nowrap custom-badge
