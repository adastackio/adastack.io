...
import { createContext as createContext5, memo, useCallback as useCallback2, useContext as useContext5, useState as useState3 } from "react";
    ...
    while ((result = regexp.exec(value)) !== null) {
      res.push(
        /* @__PURE__ */ jsxs6(Fragment4, { children: [
          ...
          /* @__PURE__ */ jsx11("span", { className: "nx-text-primary-600", children: splitText.splice(0, regexp.lastIndex - result.index).join("") })
        ] }, id++)
      );
...
import { Fragment as Fragment6, useCallback as useCallback3, useEffect as useEffect2, useRef as useRef4, useState as useState4 } from "react";
...
function Search({
    ...
    Transition,
    {
      ...
      children: /* @__PURE__ */ jsx13(
        "kbd",
        {
          ...
          children: value && focused ? "ESC" : mounted && (navigator.userAgent.includes("Macintosh") ? /* @__PURE__ */ jsxs8(Fragment7, { children: [
  ...
  return /* @__PURE__ */ jsxs8("div", { className: cn8("nextra-search nx-relative md:nx-w-64", className), children: [
      ...
      Transition,
      {
        ...
        children: /* @__PURE__ */ jsx13(
          "ul",
          {
            ...
            ] }) : results.length > 0 ? results.map(({ route, prefix, children, id }, i) => /* @__PURE__ */ jsxs8(Fragment6, { children: [
              prefix,
              /* @__PURE__ */ jsx13(
                "li",
                {
...
import { Children, cloneElement, useEffect as useEffect5, useRef as useRef7, useState as useState8 } from "react";
