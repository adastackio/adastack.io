...
seo_description: Get started with Cardano using this guide. Set up a wallet, buy ADA, and start using Dapps on Cardano. Explore the ecosystem and start using Cardano.
---
...
If you will have a large amount of ADA it is recommended to use a [hardware wallet](https://builtoncardano.com/ecosystem/hardware-wallet) for greater security. Hardware wallets are physical devices that require a pin code on the device to authorize a transaction.

The resources below give further advice for choosing and securing a wallet. Don't worry too much about choosing the perfect wallet because you can always switch later. In fact, you can use different wallets simultaneously to manage a single account's assets. This is because the assets exist on the blockchain, not in the wallet, and the wallet is just a means of executing transactions on the blockchain assets.
