...
<Steps>
### Make a Wallet
A wallet allows you to store, manage, and transact with digital assets. We will set this up first so it is ready to receive the ADA once you'v÷e purchased it on an exchange.
