...
- [CardanoPick](https://cardanopick.com/)<OS url="https://github.com/nilscodes" />: Actions you can take to learn about and support Cardano.
- [Getting On Chain Guide by SelfDriven](https://buildingoncardano.dev/getting-on-chain)<OS url="https://github.com/selfdriven-foundation" />: How to get set up and begin using dApps on Cardano.
- [Your Cardano Onboarding Guide by Essential Cardano](https://www.essentialcardano.io/article/your-cardano-onboarding-guide)<OS url="https://github.com/input-output-hk" />: Explore options after you've set up a wallet.
- [Cardano Nexus](https://www.cardanonexus.org/): Meaningful ways to engage and contribute for non-technical people.
