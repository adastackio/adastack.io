...
- [ADA Markets on CMC](https://coinmarketcap.com/currencies/cardano/#Markets): All exchanges trading ADA, ranked by daily trading volume.
...
- [Cardano on Binance](https://www.binance.com/en/how-to-buy/cardano): World's largest cryptocurrency exchange operating since 2017.

**_Pro tip:_** Choose an exchange with a [good track record](https://welcome.rabbitholepools.io/choosing-an-exchange).

### Create an Account

To set up an account, follow the steps provided by the exchange. This process will likely include identity verification, known as KYC (Know Your Customer). This step may require some documents - typically a government-issued photo ID and proof of address (like a utility bill).
...
Once you have purchased your ADA on an exchange you can send it to your wallet. [This guide explains](https://welcome.rabbitholepools.io/sending-ada-to-your-personal-wallet) how to send ADA from an exchange to a wallet.

Centralized exchanges ultimately control your digital assets until you withdraw them to your personal wallet.

**_Pro tip:_** Always double check the address you are sending to. ADA transferred to the wrong address will not be possible to recover.
...
- **Earn funding from Catalyst**. [Project Catalyst](https://projectcatalyst.io/)<OS url="https://github.com/Project-Catalyst" /> is an innovation engine for Cardano. ADA holders vote on proposals they think will benefit Cardano. Funded proposals get paid in ADA.
...
- **Buy ADA privately**. For enhanced privacy, you can look at [buying Bitcoin anonymously](https://kycnot.me/)<OS url="https://gitlab.com/kycnot/kycnot.me" />, then convert it to ADA using a cross-chain DEX. Check on legality in your location first.
