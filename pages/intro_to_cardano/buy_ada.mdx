...
- **Earn funding from Catalyst**. [Project Catalyst](https://projectcatalyst.io/) is an innovation engine for Cardano. ADA holders vote on proposals they think will benefit Cardano. Funded proposals get paid in ADA.
...
- **Buy ADA privately**. For enhanced privacy, you can look at [buying Bitcoin anonymously](https://kycnot.me/), then convert it to ADA using a cross-chain DEX. Check on legality in your location first.
