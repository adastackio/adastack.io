...
Cardano's decentralization is also reflected in the approach to governance. Cardano has a democratic system, where every significant network change must be voted on by ADA-holders to be enacted on-chain. This means that decision-making about Cardano's evolution is in the hands of the community collectively. The focus on decentralization across-the-board ensures no single entity can control or manipulate the network.
