...
Beginning in 2015, [IOG](https://iohk.io/) partnered with over [30 top institutions](https://iohk.io/en/research/), including Stanford and the University of Edinburgh. These collaborations resulted in [200+ research papers](https://iohk.io/en/research/) that provide the foundation for Cardano's security, decentralization, and reliability.

IOG translated this academic research into Cardano's software using formal methods, which include mathematical specifications, property-based testing, and proofs. This rigorous process ensures strong guarantees of correctness for the system's core components.
