...
ADA is also among the most fairly distributed cryptocurrencies. When Cardano was launched, only 11.5% was set aside for the founding entities to develop and market the blockchain. The other 88.5% is either in active circulation by Cardano users, or is set aside as block rewards (which will also go into circulation). ADA that is currently in circulation is widely distributed; it is estimated that there are over [85 million ADA holders](https://cexplorer.io/article/how-many-ada-holders-are-there-in-the-world). This wide distribution leads to a diverse and active ecosystem. [Read more about the initial distribution here](https://www.coingecko.com/en/coins/cardano/tokenomics).

### Real World Focus

Around 2 billion people, representing 38% of adults globally, remain excluded from basic financial services. Cardano provides a borderless financial system where anyone with internet can participate in the digital economy.

Here are a few of the Cardano dApps focused on finance and positive impact:

- [Empowa](https://empowa.io/): Sustainable housing finance
- [World Mobile](https://worldmobile.io/): Decentralized telecommunications
- [Palmyra](https://palmyra.app/): Sustainable supply chains
- [Pezesha](https://pezesha.com/): Financial inclusion

This system allows anyone to store value, send and receive payments, and access financial services using decentralized finance (DeFi).
...
Cardano also has a minimal environmental impact thanks to its proof-of-stake design, which replaces energy-intensive proof-of-work mining. This system [provides the same robust security guarantees](https://iohk.io/en/research/library/papers/ouroboros-a-provably-secure-proof-of-stake-blockchain-protocol/) as Bitcoin, while being around [100,000x](https://cexplorer.io/energy) more energy efficient.
