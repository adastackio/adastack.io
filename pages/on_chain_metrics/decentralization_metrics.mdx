...
The worldwide distribution of nodes across different regions, strengthening network resilience.
...
The size of a Cardano full node indicates the amount of storage needed on disk for a full copy of a blockchain.
...
Network measurements focusing on block transmission speeds and efficiency across the global network of nodes.
...
- [Pooltool.io](https://pooltool.io/networkhealth): Block propagation time and delays.
