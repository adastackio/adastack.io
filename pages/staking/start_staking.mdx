...
3. Choose a stake pool to delegate to: This is a competitive landscape. Some stake pools offer higher rewards, support charity initiatives, or reward delegators with other tokens or NFTs. You may also find it helpful to look at some [stake pool explorers](./stake_pool_explorers.mdx) to find a stake pool you like.  
