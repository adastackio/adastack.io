...
Rewards are visible in your Cardano wallet or using a [reward tracker website](/staking/stake_reward_trackers). To spend staking rewards you must click "Withdraw Rewards" in your wallet and sign the receive transaction.
