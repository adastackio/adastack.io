...
Rewards are visible in your Cardano wallet or using a [reward tracker website](). When you want to spend your staking rewards, you must "Withdraw Rewards" in your wallet and sign a transaction. 
</Steps>
...
- To improve the decentralization of the Cardano network you could consider staking with a single stake pool. The [Single Pool Alliance](https://singlepoolalliance.net/) lists many committed single stake pools. 
- It is a good idea to check your [stake pool's stats]() from time to time to make sure they are still producing blocks consistently. Stake pools can shut down or update their fees. It's easy to switch to another stake pool anytime.  
- Using the [Lace Wallet](https://www.lace.io/) or [Atrium](https://www.atrium.io/) platform, it is possible to stake to multiple pools from a single wallet. This is useful when you want to diversify rewards and support multiple pools.