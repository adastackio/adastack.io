---
seo_title: How to Start Staking
seo_description:
---
...
1. Find a stake pool that you like using a [stake pool explorer](https://adastack.io/staking/stake_pool_explorers).
...
Here are some good websites to explore stake pools:

[Cexplorer](https://cexplorer.io/pool): Search and browse all stake pools.

[Mission Driven Pools](https://missiondrivenpools.org/member-pools/): Stake pools with a positive mission.

[Single Pool Alliance](https://singlepoolalliance.net/): Stake pools that have pledged to only run a single pool.

[Community Developer Pools](https://adafolio.com/portfolio/8f7da192-0257-11eb-9684-a45e60be653b): Stake pools of developers that make significant contributions to Cardano community tools and services.

[Armada Alliance](https://armada-alliance.com/): Alliance of energy-efficient stake pools.
...
Rewards are visible in your Cardano wallet or using a [reward tracker website](https://adastack.io/staking/stake_reward_trackers). Before you can spend your staking rewards you must click "Withdraw Rewards" in your wallet and sign a transaction.
