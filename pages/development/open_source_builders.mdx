...
{ name: 'Artano', website: 'https://artano.io', repoURL: 'https://github.com/artano-io', type: 'dApp'},
{ name: 'JPG Store', website: 'https://www.jpg.store/', repoURL: 'https://github.com/jpg-store', type: 'dApp'},
{ name: 'Kreate Art', website: 'https://kreate.community/', repoURL: 'https://github.com/kreate-art', type: 'dApp'},
{ name: 'Jam on Bread', website: 'https://jamonbread.io/', repoURL: 'https://github.com/JamOnBread', type: 'dApp'},
{ name: 'SaturnSwap', website: 'https://saturnswap.io/', repoURL: 'https://github.com/Orion-Crypto', type: 'dApp'},
{ name: 'NEWM', website: 'https://newm.io/', repoURL: 'https://github.com/projectNEWM', type: 'dApp'},
{ name: 'Book.io', website: 'https://book.io/', repoURL: 'https://github.com/book-io', type: 'dApp'},
{ name: 'CSwap DEX', website: 'https://cswap.fi/', repoURL: 'https://github.com/cswapsystems', type: 'dApp'},
{ name: 'Token Riot', website: 'https://tokenriot.io/', repoURL: 'https://github.com/TokenRiot', type: 'dApp'},
{ name: 'Empowa', website: 'https://empowa.io/', repoURL: 'https://github.com/empowa-io', type: 'dApp'},
{ name: 'Awen Online', website: 'https://awen.online/', repoURL: 'https://github.com/Awen-online', type: 'Dev Shop'},
{ name: 'Begin Wallet', website: 'https://b58.finance/', repoURL: 'https://b58.finance/', type: 'dApp'},
];
        ...
        <table className="nx-block nx-overflow-x-scroll nextra-scrollbar nx-mt-6 nx-p-0 first:nx-mt-0">
          <thead>
            <tr className="nx-m-0 nx-border-t nx-border-gray-300 nx-p-0 dark:nx-border-gray-600 even:nx-bg-gray-100 even:dark:nx-bg-gray-600/20">
              ...
              <th className="nx-m-0 nx-border nx-border-gray-300 nx-px-4 nx-py-2 nx-font-semibold dark:nx-border-gray-600">Short Description</th>
            </tr>
          </thead>
          <tbody>
