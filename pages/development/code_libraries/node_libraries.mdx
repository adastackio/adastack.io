...
Dolos is a lightweight Cardano data node that maintains a current ledger copy and handles queries from trusted clients. Without block production or relay functions, serving as an efficient backend for dApps and indexers.
