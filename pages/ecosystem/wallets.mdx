...
<WalletsTable wallets={wallets} filterBy="mobile_wallet" />
...
<WalletsTable wallets={wallets} filterBy="browser_wallet" />
...
<WalletsTable wallets={wallets} filterBy="desktop_wallet" />
...
<WalletsTable wallets={wallets} filterBy="hardware_wallet" />
...
<WalletsTable wallets={wallets} filterBy="web_wallet" />
...
<WalletsTable wallets={wallets} filterBy="paper_wallet" />
...
<WalletsTable wallets={wallets} filterBy="identity_wallet" />
...
<WalletsTable wallets={wallets} filterBy="multisig_wallet" />
...
<WalletsTable wallets={wallets} filterBy="dev_wallet" />
...
<WalletsTable wallets={wallets} filterBy="specialized_wallet" />
