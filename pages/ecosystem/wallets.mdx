...
Wallets allow you to manage digital assets, make transactions, and use Cardano applications. For security tips and setup instructions, visit [Set up a Wallet](../intro_to_cardano/set_up_a_wallet).
...
Wallets that securely store personal identification credentials and essential documents in an encrypted format. They allow for robust security and enhanced privacy for identity items.
