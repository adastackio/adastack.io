...
[Project Catalyst](https://docs.projectcatalyst.io/)<OS url="https://github.com/Project-Catalyst" /> is a collective innovation fund for Cardano. The fund holds regular rounds in which projects can apply for funding to build something beneficial on Cardano. Once the proposals submitted, ADA-holders vote on which ones to fund. Catalyst is sustainably funded using the [Cardano treasury](https://cexplorer.io/pot)<OS url="https://github.com/cexplorer" />.
