...
[Project Catalyst](https://docs.projectcatalyst.io/) is a collective innovation fund for Cardano. The fund holds regular rounds in which projects can apply for funding to build something beneficial on Cardano. Once the proposals submitted, ADA-holders vote on which ones to fund. Catalyst is sustainably funded using the [Cardano treasury](). 
